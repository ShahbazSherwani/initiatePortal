        ...
        <ProjectFormProvider>
          <Routes>
            <Route element={<MainLayout />}>
              ...
              {/* Investor routes - move these inside MainLayout */}
              <Route path="/investor/discover" element={<InvestorDiscovery />} />
              <Route path="/investor/project/:projectId" element={<InvestorProjectView />} />
